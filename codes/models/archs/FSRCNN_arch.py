...
class FSRCNN_net(torch.nn.Module):
    def __init__(self, input_channels, upscale, d=56, s=12, m=4):
        ...
        self.tail_conv = nn.ConvTranspose2d(
            in_channels=d, out_channels=input_channels,
            kernel_size=9, stride=upscale, padding=3, output_padding=1
        )
